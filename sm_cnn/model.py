...
class SMModel(nn.Module):
    def __init__(self, config):
        ...
        n_classes = 2
        self.ext_feats_size = 4 if config.ext_feats else 0
        input_channel = 1
        ...
        n_hidden = 2 * output_channel + self.ext_feats_size
    ...
    def forward(self, x_question, x_answer, x_ext=None):
