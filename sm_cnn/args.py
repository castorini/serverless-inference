...
def get_args():
    ...
    parser.add_argument('--ext_feats', action='store_true', default=False, help='use external features')
    ...
    parser.add_argument('--trained_model', type=str, default='saves/TREC/static_best_model.pt')
